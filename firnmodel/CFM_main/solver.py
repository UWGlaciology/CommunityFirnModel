...
def transient_solve_EN(z_edges, Z_P, nt, dt, Gamma_P, phi_0, nz_P, nz_fv, phi_s, tot_rho, enthalpy_l):
    '''
    transient 1-d diffusion finite volume method
...
# def transient_solve_EN(z_edges, Z_P, nt, dt, Gamma_P, phi_0, nz_P, nz_fv, phi_s, tot_rho):
#     '''
#     transient 1-d diffusion finite volume method
