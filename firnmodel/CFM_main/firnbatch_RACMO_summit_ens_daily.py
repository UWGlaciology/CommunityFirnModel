...
# print nn
connm='RACMOjson/RACMO_Summit_config_daily_'+mm+'_ens.json'
copyfile('RACMO_Summit_config_master_daily.json', connm)
...
re="RACMOresults_ens_all/rdaily/" + mm #results folder
