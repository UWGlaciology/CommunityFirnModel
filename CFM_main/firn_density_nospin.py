        ...
        for iii in range(self.stp):
            ...
            if self.c['rad_pen']:
                if iii==0:
                    ...
                    # print(deltaE_layers1[0:10]-deltaE_layers1[1:11])
                    # deltaE_layers = deltaE_layers1 * self.dz 
                    # print(deltaE_layers[0:10])
                    ...
                    # print(self.modeltime[iii], self.z[0:3],self.dz[0:3],deltaT[100])
