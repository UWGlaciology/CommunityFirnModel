...
def HLdynamic(steps, gridLen, bdotSec, Tz, rho):
    '''
...
def HLSigfus(steps, gridLen, bdotSec, Tz, rho, sigma):
    '''
...
def Li2004(steps, gridLen, bdotSec, T_mean, rho):
    '''
...
def Li2011(steps, gridLen, bdotSec, bdot_mean, bdot_type, Tz, T_mean, rho):
    '''
...
def Arthern2010S(steps, gridLen, bdotSec, bdot_mean, bdot_type, Tz, T_mean, rho):
    '''
...
def Arthern2010T(gridLen, Tz, rho, sigma, r2, physGrain):
    '''
...
def Helsen2008(steps, bdotSec, bdot_mean, Tz, Ts, rho, bdot_type):
    '''
...
def Simonsen2013(steps, gridLen, bdotSec, bdot_mean, bdot_type, Tz, T_mean, rho):
    '''
...
def Ligtenberg2011(steps, gridLen, bdotSec, bdot_mean, bdot_type, Tz, T_mean, rho):
    '''
...
def Barnola1991(steps, gridLen, bdotSec, Tz, rho, sigma):
    '''
...
def Morris2013(steps, spin, iter, gridLen, Tz, dt, rho):
    '''
