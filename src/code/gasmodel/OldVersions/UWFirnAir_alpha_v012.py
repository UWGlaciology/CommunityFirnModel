...
# sys.path.insert(1, '~/Documents/Grad_School/PIRE/FMbeta/code/gasmodel')
...
#     rho0=0.36
    ...
    #load data: firn air samples.
    
    gaschoice='CO2'
    D_x, M, deltaM, conc1, firn_meas = MPG.gasses(gaschoice,T,p_a,DataPath)
#     D_x = 1. #free-air diffusivity relative to CO2
#     M = 44.01e-3 # molecular mass
#     deltaM=10.1 #delta molecular mass from CO2.
#     conc1=np.loadtxt('SCENARIO_NEEM08_CO2.txt',skiprows=1) #load data: atmospheric CO2 history.
#     firn_meas=np.loadtxt('CO2samples.txt',skiprows=2)
