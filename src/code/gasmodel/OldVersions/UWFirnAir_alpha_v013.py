...
# Working on updating fractionation physics, downward advection, and transience.
...
def diffusivity():
    ...
    deepnodes = z_nodes>LIZ #leftover line from matlab? Might be useful at some point.
...
if __name__ == "__main__":
    ...
    sitechoice = 'NEEM'
    g, depth, p_a, T, Accu, czd, z_co, LIZ, rho0 = MPS.sites(sitechoice)
