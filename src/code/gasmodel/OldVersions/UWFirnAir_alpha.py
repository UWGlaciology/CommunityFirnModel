...
def w(z_edges_vec,Accu,rho_interface,por_op,T,p_a):
    M_air = 29e-3
    rho_i=0.917
    g=9.81
    R = 8.314
    ...
    w = 1.7*Accu/rho_interface
    #w = A*rho_i/(por_op_star*p_a)*(
...
def transient_solve(z_edges_vec,z_P_vec,nt,dt,Gamma_P,bc_u,bc_d,phi_0,rhoHL,deepnodes,R,nz_P,nz_fv,por_op,gas,Accu,T,p_a):
    ...
    w_edges = w(z_edges_vec,Accu,rho_interface,por_op,T,p_a)
...
def diffusivity(rho_i,rhoHL,z_nodes):
    ...
    rho_co = 0.815 # User chosen close off-density (put in site-specific in sites.m?)
    ...
    return diffu,deepnodes,por_op,d_eddy,diffu_full_fre,diffu_full_sch,diffu_full_Sev,diffu_full_Christo
...
if __name__ == "__main__":
    ...
    diffu, deepnodes, por_op, d_eddy, diffu_full_fre,diffu_full_sch,diffu_full_Sev, diffu_full_Christo = diffusivity(rho_i,rhoHL,z_nodes) #get diffusivity profiles
    ...
    phi=transient_solve(z_edges_vec,z_P_vec,nt,dt,Gamma_P,bc_u,bc_d,phi_0,rhoHL,deepnodes, R,nz_P,nz_fv,por_op,gas,Accu,T,p_a)
